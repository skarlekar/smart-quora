...
When using Hyperledger Fabric, Hyperledger Composer issues new identities by using the Hyperledger Fabric certificate authority (CA) to register new enrollment certificates. These identities are then use
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzc1MTIwODEsLTI4NjMxMTQyNSwyMT
