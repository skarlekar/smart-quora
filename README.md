...
**Answer** - An answer consists of an unique id, answer description, owner, status (CREATED, VOTED, AWARDED), earnings, and a list of voters. When a question is awarded, the earnings attribute reflect the earnings that was generated by that particular answer
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjgxOTY5NjMzLDEzMzE0Nzk3NDIsNDQ2ND
