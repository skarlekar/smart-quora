...
2.  **Peer**: A peer receives ordered state updates in the form of _blocks_ from the ordering service and maintain the state and the ledger. Peers can additionally take up a special role of an **endorsing peer**, or an **endorser** which uses endorsement policies .
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1NjcyMjE1XX0=
-->